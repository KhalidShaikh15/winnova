  ...
  return (
    <div className="container py-12">
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle className="text-3xl font-bold text-center">Terms &amp; Conditions – BattleBuck Tournaments</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6 text-muted-foreground">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>BattleBuck reserves the right to change rules, reschedule matches, or disqualify players if needed.</li>
            </ul>
          </div>
          <div>
